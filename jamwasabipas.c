...
#include "./jwasabipas/jamsyn_wasabipas39.c"
//#include "./jwasabipas/jamsyn_sirpas50.c"
//#include "./jsirpastdc/jamsyn_sirpas40.c"
...
int main(void)
{
  ...
  jata.jga.cpop[jata.jga.id][86] = 5; // 5 -> 11
  jata.jga.cpop[jata.jga.id][88] = 0; //5 -> 13
  jata.jga.cpop[jata.jga.id][178] = 0; // 11 -> 13
  jata.jga.cpop[jata.jga.id][193] = 0; // 12 -> 13
  jata.jga.cpop[jata.jga.id][193] = 0; // 12 -> 13
  ...
  jata.jga.cpop[jata.jga.id][223] = 0; // 14 -> 13
  ...
  jata.jga.cpop[jata.jga.id][230] = 5; // i5
  jata.jga.cpop[jata.jga.id][231] = 0; // i6
  jata.jga.cpop[jata.jga.id][232] = 0; // i7
  jata.jga.cpop[jata.jga.id][233] = 5; // i8
  jata.jga.cpop[jata.jga.id][234] = 0; // i9
  jata.jga.cpop[jata.jga.id][235] = 0; // i10
  jata.jga.cpop[jata.jga.id][236] = 2; // i11
  jata.jga.cpop[jata.jga.id][237] = 0; // i12
  jata.jga.cpop[jata.jga.id][238] = 0; // i13
  jata.jga.cpop[jata.jga.id][239] = 0; // i14
  ...
  for (jata.r[0] = 0; jata.r[0] < cellnumb; jata.r[0]++){
    printf("The total action potential count for cell %d was %d\n", jata.r[0], jata.taps[jata.r[0]]);
    sprintf(&jata.fname[0], "./output/jstrfaasirpas150%d.txt", jata.r[0]);
    ...
    fclose(jata.f);
    sprintf(&jata.fname[0], "./output/jstrfsirpas150%d.txt", jata.r[0]);
    //sprintf(&jata.fname[0], "./output/jstrfjjb39%d.txt", jata.r[0]);
    jata.f = fopen(&jata.fname[0], "w");
    ...
    fclose(jata.f);
    sprintf(&jata.fname[0], "./output/jstrfsddg3sirpas150%d.txt", jata.r[0]);
    //sprintf(&jata.fname[0], "./output/jstrfsdg3jjb%d.txt", jata.r[0]);
    jata.f = fopen(&jata.fname[0], "w");
    for (jata.r[1] = 0; jata.r[1] < sftorc; jata.r[1]++){
      for (jata.r[2] = 0; jata.r[2] < sttorc; jata.r[2]++){
