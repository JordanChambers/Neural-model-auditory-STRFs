...
#include <math.h>
#include <mpi.h>
#include "./joni/jheaders.h"
#include "./joni/jstructure.c"
#include "./joni/jsoundsignal.c"
#include "./joni/jwav2aud.c"
#include "./joni/jnetwork.c"
#include "./joni/jnetwork_is.c"
#include "./joni/jstrf.c"
#include "./joni/jga.c"

#include "./joni/jamsyn.c"
//#include "./joni/jamsyn_dai009a-c2pas03.c"
...
int main(void)
{
  ...
  for (jata.r[0] = 0; jata.r[0] < cellnumb; jata.r[0]++){
    ...
    else if (jata.jopt == 180){
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1act0%d%dns.txt", jata.r[4], jata.r[0]);
    }
    else if (jata.jopt == 181){
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1pas0%d%dns.txt", jata.r[4], jata.r[0]);
    }
    ...
    if (jata.jopt == 50){
      ...
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1act0%d%dsm.txt", jata.r[4], jata.r[0]);
    }
    else if (jata.jopt == 181){
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1pas0%d%dsm.txt", jata.r[4], jata.r[0]);
    }
    else if (jata.jopt == 230){
    ...
    if (jata.jopt == 50){
      ...
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1act0%d%dsmg3.txt", jata.r[4], jata.r[0]);
    }
    else if (jata.jopt == 181){
      sprintf(&jata.fname[0], "./output/jamsyn_oni015b-b1pas0%d%dsmg3.txt", jata.r[4], jata.r[0]);
    }
    else if (jata.jopt == 230){
